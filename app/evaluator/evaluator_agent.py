...
def create_evaluation_prompt(
    ...
    if output_type == "text":
        ...
        prompt_parts.append("Note: Evaluate based on the prompt's ability to generate images.\n")
    elif output_type == "pdf_url":
        prompt_parts.append(f"[PDF URL]: {ai_output}\n")
        prompt_parts.append("Note: Evaluate based on the prompt's ability to generate documents.\n")
