...
class PromptEvaluationRequest(BaseModel):
    ...
    expected_outcome: Optional[str] = Field(
        None,
        description="What the user expected to achieve (optional)"
    )
    ai_model_used: Optional[str] = Field(
        None,
        description="Which AI model was used (e.g., ChatGPT, Claude, Gemini)"
    )
...
class EvaluationFeedback(BaseModel):
    ...
    prompt_quality: dict = Field(
        ...,
        description="Analysis of prompt quality"
    )
    output_analysis: dict = Field(
        ...,
        description="Analysis of the AI output"
    )
    ...
    revised_prompt: Optional[str] = Field(
        None,
        description="Suggested improved version of the prompt"
    )
