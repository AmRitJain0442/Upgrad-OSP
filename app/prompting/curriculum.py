...
FULL_CURRICULUM = [
    {
        "id": "gamma-tool",
        "title": "Gamma AI Tool Mastery",
        "description": "Learn to use Gamma - the AI-powered presentation tool with hands-on practice",
        "submodules": [
            {
                "id": 1,
                "title": "Introduction to Gamma",
                "description": "Learn what Gamma is and explore its interface",
                "welcome_message": "Welcome to Gamma Tool Mastery! Gamma is a revolutionary AI-powered presentation tool that makes creating beautiful slides effortless. Let's explore how it works!",
                "learning_objectives": [
                    "Understand what Gamma is and its key features",
                    "Navigate the three modes: Create, Edit, and Present",
                    "Learn when to use Gamma vs traditional tools like PowerPoint"
                ],
                "key_features": [
                    "✨ **AI Generation**: Create entire presentations from just a topic or document",
                    "🎨 **Smart Themes**: Professional designs that auto-adapt to your content",
                    "✏️ **Live Editing**: Edit text and content directly on the canvas",
            ...
            {
                "id": 2,
                "title": "Create Mode - AI Generation",
                "description": "Master creating presentations with AI",
                "welcome_message": "Let's dive into Gamma's most powerful feature - AI generation! You'll learn three ways to create presentations.",
                "creation_methods": [
                    {
                        "name": "Start from Blank",
                        "icon": "📄",
                        "use_case": "When you want complete creative control",
                        "tip": "Best for unique layouts or specific design needs"
                    },
                    {
                        "name": "Generate with AI",
                        "icon": "✨",
                        "use_case": "When you want AI to create content and structure",
                        "tip": "Provide detailed topics for best results"
                    },
                    {
                        "name": "Import Content",
                        "icon": "📥",
                        "use_case": "When you have existing PowerPoint, PDF, or documents",
                        "tip": "Gamma will intelligently convert and enhance your content"
                    }
                ],
                "ai_options": [
                    "📝 **Concise (5-7 slides)**: Quick overviews and summaries",
                    "📚 **Detailed (10-15 slides)**: Comprehensive presentations",
                    "🎯 **Pitch Deck**: Investor-ready startup pitches",
                    "🎓 **Educational**: Teaching and training materials"
                ],
                "pro_tips": [
                    "Be specific in your topic description",
                    "Include key points you want covered",
                    "Mention your target audience",
                    "Specify the tone (formal, casual, technical)"
                ],
                "completed": False
            },
            {
                "id": 3,
                "title": "Edit Mode - Customization",
                "description": "Learn to edit and customize your presentations",
                "welcome_message": "Now that you can create presentations, let's master editing! You'll learn to customize every aspect of your slides.",
                "interface_sections": [
                    {
                        "name": "Left Sidebar - Slides",
                        "features": ["View all slides", "Reorder slides", "Add new slides", "Delete slides"]
                    },
                    {
                        "name": "Center - Canvas",
                        "features": ["Direct text editing", "Drag & drop elements", "Visual preview", "Real-time updates"]
                    },
                    {
                        "name": "Right Sidebar - Properties",
                        "features": ["Change themes", "Select layouts", "Add elements", "AI features"]
                    }
                ],
                "toolbar_features": [
                    "↶↷ **Undo/Redo**: Navigate your editing history",
                    "**BIU** **Text Formatting**: Bold, Italic, Underline",
                    "🎨 **Colors**: Change text and background colors",
                    "☰ **Alignment**: Left, center, right alignment",
                    "✨ **AI Assist**: Get AI help anytime"
                ],
                "theme_guide": [
                    "🎯 **Professional**: Clean, business-ready designs",
            ...
            },
            {
                ...
                "description": "Master slide layouts and adding elements",
                "welcome_message": "Layouts and elements are the building blocks of great presentations. Let's learn to use them effectively!",
                "layout_types": [
                    {
                        "name": "Title Slide",
                        "use": "Opening slide with main title and subtitle",
                        "best_for": "Presentation start, section dividers"
                    },
                    {
                        "name": "Title + Content",
                        "use": "Header with body content below",
                        "best_for": "Main content slides, explanations"
                    },
                    {
                        "name": "Two Column",
                        "use": "Split content into two sections",
                        "best_for": "Comparisons, pros/cons, before/after"
                    },
                    {
                        "name": "Image + Text",
                        "use": "Visual content with supporting text",
                        "best_for": "Product showcases, visual explanations"
                    }
                ],
                "elements": [
                    {
                        "type": "Text",
                        "icon": "📝",
                        "tip": "Click anywhere to add text boxes with custom formatting"
                    },
                    {
                        "type": "Image",
                        "icon": "🖼️",
                        "tip": "Upload images or generate them with AI"
                    },
                    {
                        "type": "Video",
                        "icon": "🎥",
                        "tip": "Embed YouTube, Vimeo, or upload videos"
                    },
                    {
                        "type": "Chart",
                        "icon": "📊",
                        "tip": "Create data visualizations - bar, line, pie charts"
                    },
                    {
                        "type": "Table",
                        "icon": "📋",
                        "tip": "Organize data in rows and columns"
                    },
                    {
                        "type": "Code",
                        "icon": "💻",
                        "tip": "Add syntax-highlighted code blocks"
                    }
                ],
                "completed": False
            },
            {
                ...
                "description": "Unlock Gamma's advanced AI capabilities",
                "welcome_message": "Gamma's AI doesn't stop at generation - it helps you improve, extend, and enhance your entire presentation!",
                "ai_features": [
                    {
                        "name": "AI Assist",
                        "description": "Get AI help for any slide",
                        "examples": [
                    ...
                    {
                        "name": "Extend Content",
                        "description": "Add more slides or expand existing ones",
                        "scenarios": [
                            "Add 3 slides about [subtopic]",
                            "Expand this section with examples",
                            "Create supporting slides for this concept",
                            "Add a conclusion section"
                        ]
                    }
                ],
                "best_practices": [
                    "🎯 Be specific in your AI requests",
                    "✅ Review and refine AI-generated content",
                    "🔄 Iterate - ask AI to refine multiple times",
            ...
            {
                "id": 6,
                "title": "Present Mode & Sharing",
                "description": "Learn to present and share your work",
                "welcome_message": "You've created an amazing presentation - now let's learn how to present and share it with the world!",
                "present_mode_features": [
                    "🖥️ **Full-Screen Mode**: Professional presentation view",
                    "⌨️ **Keyboard Controls**: Arrow keys for navigation",
                    "🎯 **Presenter Notes**: Private notes visible only to you",
                ...
                "sharing_options": [
                    {
                        "method": "Live Link",
                        "description": "Share a link that always shows the latest version",
                        "best_for": "Team collaboration, live presentations"
                    },
                    {
                        "method": "Export PDF",
                        "description": "Download as PDF for offline viewing",
                        "best_for": "Print handouts, email attachments"
                    },
                    {
                        "method": "Export PowerPoint",
                        "description": "Convert to .pptx format",
                        "best_for": "Editing in PowerPoint, compatibility"
                    },
                    {
                        "method": "Embed Code",
                        "description": "Embed in websites or blogs",
                        "best_for": "Portfolio websites, documentation"
                    }
                ],
                "presentation_tips": [
                    ...
                    "Test links and videos before presenting",
                    "Use animations sparingly for professionalism"
                ],
                "completed": False
            }
        ]
